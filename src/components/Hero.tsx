...
export const Hero: React.FC = () => {
    return (
        <section className="relative flex items-center overflow-hidden bg-brand-light py-10 sm:py-14 md:py-20 lg:py-24 min-h-0 sm:min-h-[86vh] lg:min-h-[84vh]">
                ...
                <div className="surface-soft p-5 sm:p-8 md:p-10 lg:p-12 flex flex-col-reverse lg:flex-row items-center gap-6 md:gap-10 lg:gap-16">
                    ...
                    <div className="w-full lg:w-3/5 space-y-5 md:space-y-8 animate-fade-in-up">
                        ...
                        <div className="flex flex-col items-start gap-1 mb-2">
                            ...
                            <span className="text-[11px] uppercase tracking-[0.2em] text-brand-primary font-bold">Psicologia Clínica • CRP 06/118764</span>
                        </div>
                        ...
                        <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-white/80 backdrop-blur-sm border border-stone-200/60 shadow-sm">
                            ...
                            <span className="text-[11px] font-bold tracking-[0.16em] uppercase text-brand-slate">Psicoterapia Online</span>
                        </div>
            ...
            <div className="absolute bottom-10 left-1/2 -translate-x-1/2 hidden md:flex flex-col items-center gap-2 opacity-40 hover:opacity-60 transition-opacity">
